...
async function initializeTranslation() {
    try {
        ...
        addStylesheet('css/translate.css');
        ...
        let elementsWithTranslate = document.body.querySelectorAll('[translate="yes"]');
        ...
        let observer = new MutationObserver((mutations) => {
            mutations.forEach(mutation => {
                if (mutation.type === 'childList' && mutation.addedNodes.length > 0 || mutation.type === 'characterData' && mutation.target.nodeValue.trim() !== '') {
                    callEvent(cached);
                }

                elementsWithTranslate = document.body.querySelectorAll('[translate="yes"]');
