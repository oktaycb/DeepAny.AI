...
export function showSidebar(sidebar, hamburgerMenu) {
    ...
    if (!sidebarLoaded) {
        ...
        sidebar.innerHTML = loadSideBar;['exploreButton', 'profileButton', 'premiumButton', 'faceSwapButton', 'inpaintButton', 'artGeneratorButton', 'videoGeneratorButton'].forEach(id => document.getElementById(id).addEventListener('click', () => localStorage.setItem('sidebarState', 'removeSidebar')));
        sidebarLoaded = true;
    }
}
