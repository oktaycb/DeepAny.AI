				...
				<nav class="navbar">
					<div class="container">
						<div class="logo">
							...
							<h2 onclick="location.href='/'" style="cursor: pointer;" translate="no">${document.title.split(':')[0].split('.')[0]}.<span class="text-gradient" translate="no">${document.title.split(':')[0].split('.')[1]}</span></h2>
						</div>
					</div>
				</nav>
			...
			<ul class="nav-links" style="display: grid;grid-template-columns: 2fr 1fr 2fr;justify-items: center;">
				<li>
					...
					<ul class="dropdown-menu">
						...
						<li><a class="text" href="inpainter.html">Inpaint</a></li>
